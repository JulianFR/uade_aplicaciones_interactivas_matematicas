import * as SumaRestaEjercicioHelper from './AsociacionEjercicio.helper';
import { JuegoNiveles } from '../Asociacion.model';
...
export class SumaRestaEjercicio {
  ...
  corregir(): SumaRestaEjercicio {
    ...
    return this.clonar((+this.entrada === this[this.incognita]) ? "correcto" : "incorrecto");
  }
